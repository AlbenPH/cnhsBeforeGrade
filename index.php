                    ...
                    <li class="navbar-item dropdown header-admin">
                        <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                            ...
                            <div class="admin-title">
                                ...
                                <h5 class="item-title"> <?php echo isset($userInfo["firstname"]) ? $userInfo["firstname"] : '' ; ?>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="item-header">
                                <h6 class="item-title"> <?php echo isset($userInfo["firstname"]) ? $userInfo["firstname"] : '' ; ?>
               ...
               <div class="mobile-sidebar-header d-md-none">
                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item">
                            <a href="teachersList.php" class="nav-link"><i
                                    class="flaticon-settings"></i><span>Teachers</span></a>
                        </li>

                        <li class="nav-item">
                            <a href="php/nonTeachingPersonel.php" class="nav-link"><i
                                    class="flaticon-settings"></i><span>Employees</span></a>
                        </li>



                        <li class="nav-item">
                            <a href="adminslist.php" class="nav-link"><i
                                    class="flaticon-settings"></i><span>Admins</span></a>
                        </li>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="dashboard-summery-one mg-b-20">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        <div class="item-title">Male Students</div>
                                        <div class="item-number"><span class="counter" data-num="132">132</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="dashboard-summery-one mg-b-20">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        <div class="item-title">Female Students</div>
                                        <div class="item-number"><span class="counter" data-num="221">5,690</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="dashboard-summery-one mg-b-20">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        <div class="item-title">Graduating Students</div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="dashboard-summery-one mg-b-20">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        <div class="item-title">Teachers Count</div>
                                        <div class="item-number"><span class="counter" data-num="11">11</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="dashboard-summery-one mg-b-20">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        <div class="item-title">admin staff</div>
