...
<head>
    ...
    <title>CNHS | Admission Form</title>
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form class="new-added-form" action="php/project.php" method="POST">
                            <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        ...
                                        <input type="text" name="DateOfBirth" placeholder="yyyy /mm/dd" class="form-control air-datepicker"
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>LRN </label>
                                        <input type="text" placeholder="" class="form-control" name="Lrn" id="ref">
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Phone</label>
                                ...
                                <div class="col-12 form-group mg-t-8">
                                    <button type="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark" id="savebtn">Save</button>
