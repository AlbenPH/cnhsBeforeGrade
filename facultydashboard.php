                    ...
                    <li class="navbar-item dropdown header-admin">
                        <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                            ...
                            <div class="admin-title">
                                <h5 class="item-title"><?php echo isset($userInfo["lastname"]) ? $userInfo["firstname"] : ''; ?></h5>
                                <span><?php echo isset($userInfo["role"]) ? $userInfo["role"] : ''; ?></span>
                            </div>
                            <div class="admin-img">
               ...
               <div class="mobile-sidebar-header d-md-none">
                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item">
                            <a href="noticeBoard.html" class="nav-link"><i
                                    class="flaticon-settings"></i><span>Annoucements </span></a>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        ...
                                        <div class="item-number"><span class="counter" data-num="55">55</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="dashboard-summery-one mg-b-20">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        <div class="item-title">Female Student</div>
                                        <div class="item-number"><span class="counter" data-num="2">12</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="dashboard-summery-one mg-b-20">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        <div class="item-title">Subject Handled</div>
